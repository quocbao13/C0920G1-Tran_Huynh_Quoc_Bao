            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1>EDIT EDUCATION LEVEL</h1>
                    </div>
                    <form class="col-12" method="post">
                        <c:if test="${educationLevel != null}">
                            <input type="hidden" name="id" value="<c:out value="${educationLevel.getId()}"/>">
                        </c:if>
                        <div class="form-group col-12">
                            ...
                            <input type="text" name="name" class="form-control col-12 float-left mt-2"
                                   id="exampleInputName" value="<c:out value="${educationLevel.getName()}"/>">
                        </div>
