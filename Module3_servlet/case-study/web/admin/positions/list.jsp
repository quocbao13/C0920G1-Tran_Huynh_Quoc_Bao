        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <a class="mb-1" href="/admin/positions?action=create"><button class="btn btn-primary float-left">
                            Create
                        </button></a>
                    </div>
                    <div class="col-12">
                        <table id="tableList" class="table table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                <c:forEach var="position" items="${requestScope['positions']}" varStatus="count">
                                    <tr>
                                        <td class="text-center">${count.count}</td>
                                        <td>${position.getName()}</td>
                                        <td class="text-center">
                                            <a href="/admin/positions?action=edit&id=${position.getId()}"
                                               role="button" class="btn btn-large btn-warning">Edit</a>
                                            <!-- Button trigger modal -->
                                            <a href="#myModal_${position.getId()}" role="button" class="btn btn-large btn-danger"
                                               data-toggle="modal">Delete</a>
                                        </td>
                                    </tr>
                                    <!-- Modal -->
                                    <div id="myModal_${position.getId()}" class="modal fade">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/admin/positions?action=delete&id=${position.getId()}"
