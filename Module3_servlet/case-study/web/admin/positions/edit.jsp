                ...
                <div class="row">
                    ...
                    <form class="col-12" method="post">
                        <c:if test="${position != null}">
                            <input type="hidden" name="id" value="<c:out value="${position.getId()}"/>">
                        </c:if>
                        <div class="form-group col-12">
                            ...
                            <input type="text" name="name" class="form-control col-12 float-left mt-2"
                                   id="exampleInputName" value="<c:out value="${position.getName()}"/>">
                        </div>
                        <button type="submit" class="btn btn-primary float-right">Edit</button>
                        <a href="/admin/positions"><button type="button" class="btn btn-info float-right">Back</button></a>
                    </form>
                </div>
            </div>
        </div>
