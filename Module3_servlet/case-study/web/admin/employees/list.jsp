        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <a class="mb-1" href="/admin/employees?action=create"><button class="btn btn-primary float-left">
                            Create
                        </button></a>
                    </div>
                    <div class="col-12">
                        <table id="tableList" class="table table-striped table-hover table-bordered">
                            ...
                            <tbody>
                            <c:forEach var="employee" items="${requestScope['employees']}" varStatus="count">
                                <tr>
                                    <td class="text-center">${count.count}</td>
                                    <td>${employee.getName()}</td>
                                    <td>${employee.getDivision().getName()}</td>
                                    <td>${employee.getEducationLevel().getName()}</td>
                                    <td>${employee.getPosition().getName()}</td>
                                    <td class="text-center">
                                        <a href="/admin/employees?action=edit&id=${employee.getId()}"
                                           role="button" class="btn btn-large btn-warning">Edit</a>
                                        <!-- Button trigger modal -->
                                        <a href="#myModal_${employee.getId()}" role="button" class="btn btn-large btn-danger"
                                           data-toggle="modal">Delete</a>
                                    </td>
                                </tr>
                                <!-- Modal -->
                                <div id="myModal_${employee.getId()}" class="modal fade">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="/admin/employees?action=delete&id=${employee.getId()}"
