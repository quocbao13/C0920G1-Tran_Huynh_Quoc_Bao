        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <a class="mb-1" href="/admin/services?action=create"><button class="btn btn-primary float-left">
                            Create
                        </button></a>
                    </div>
                    <div class="col-12">
                        <table id="tableList" class="table table-striped table-hover table-bordered">
                            ...
                            <tbody>
                            <c:forEach var="service" items="${requestScope['services']}" varStatus="count">
                                <tr>
                                    <td class="text-center">${count.count}</td>
                                    <td>${service.getName()}</td>
                                    <td>${service.getRentType().getName()}</td>
                                    <td>${service.getServiceType().getName()}</td>
                                    <td class="text-center">
                                        <a href="/admin/services?action=edit&id=${service.getId()}"
                                           role="button" class="btn btn-large btn-warning">Edit</a>
                                        <!-- Button trigger modal -->
                                        <a href="#myModal_${service.getId()}" role="button" class="btn btn-large btn-danger"
                                           data-toggle="modal">Delete</a>
                                    </td>
                                </tr>
                                <!-- Modal -->
                                <div id="myModal_${service.getId()}" class="modal fade">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="/admin/services?action=delete&id=${service.getId()}"
